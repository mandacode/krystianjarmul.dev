...
const en: SiteContent = {
  ...
  hero: {
    ...
    sub: "Systems thinking and understanding the domain are. Six years of backend engineering for SaaS products, most of it in domains where the data does not arrive in a tidy API.",
...
const pl: SiteContent = {
  ...
  hero: {
    ...
    sub: "Trudne jest myślenie systemowe i rozumienie domeny. Sześć lat backendu przy produktach SaaS, w większości w domenach, w których dane nie przychodzą gotowym API.",
